...
export let truck_service = new TruckService();


function start_app(max_payload) {

  factories_storage.push(
    new Factory(0, new GeoPoint(55.755826, 37.6173),  max_payload),
    new Factory(1, new GeoPoint(57.8136, 28.3496),    max_payload),
    new Factory(2, new GeoPoint(48.71939, 44.50184),  max_payload));
  ...
  outposts_storage.push(
    new Outpost(0, new GeoPoint(55.855898,	29.964459), 0.8),
    new Outpost(1, new GeoPoint(56.030129,	28.690065), 0.8),
    new Outpost(2, new GeoPoint(56.080129,	28.278488), 0.8),
    new Outpost(3, new GeoPoint(55.839097,	29.387026), 0.8),
    new Outpost(4, new GeoPoint(55.602565,	30.822907), 0.8),
    new Outpost(5, new GeoPoint(55.458740,	30.908523), 0.8),
    new Outpost(6, new GeoPoint(54.983001,	30.972314), 0.8),
    new Outpost(7, new GeoPoint(54.691507,	30.987881), 0.8),
    new Outpost(8, new GeoPoint(54.599174,	31.180496), 0.8),
    new Outpost(9, new GeoPoint(54.058487,	31.885151), 0.8),
    new Outpost(10, new GeoPoint(53.773852,	32.286388), 0.8),
    new Outpost(11, new GeoPoint(53.293477,	32.580795), 0.8),
    new Outpost(12, new GeoPoint(52.440510,	31.604496), 0.8),
    new Outpost(13, new GeoPoint(52.366600,	33.238169), 0.8),
    new Outpost(14, new GeoPoint(51.872128,	34.323022), 0.8),
    new Outpost(15, new GeoPoint(51.654727,	34.114326), 0.8),
    new Outpost(16, new GeoPoint(50.297031,	36.283095), 0.8),
    new Outpost(17, new GeoPoint(48.291290,	39.906557), 0.8),);

  second_outposts_storage.push(
    new SecondOutpost(18, new GeoPoint(51.172600,	23.805953), 0.7),
    new SecondOutpost(19, new GeoPoint(50.277286,	23.559936), 0.7),
    new SecondOutpost(20, new GeoPoint(49.947370,	23.139281), 0.7),
    new SecondOutpost(21, new GeoPoint(52.070867,	23.628843), 0.7),
    new SecondOutpost(22, new GeoPoint(53.527341,	23.666350), 0.7));
...
export function clear_all() {
  ...
  truck_service = new TruckService();
